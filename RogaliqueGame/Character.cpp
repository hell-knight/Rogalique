...
{
	Character::Character(const MyEngine::Vector2Df& position, MyEngine::GameObject* player, const std::string& name)
		: player(player)
	{
	...
	MyEngine::GameObject* Character::GetGameObject() const
	{
		return gameObject;
	}
